...
#2021.2
docker build -f increbuild/linux/Dockerfile -t sparrow-harbor.fasoo.com:32023/infra/teamcity-agent:2021.2.2-linux-sudo-sparrow-1  -t sparrow-harbor.fasoo.com:32023/infra/teamcity-agent:latest .


docker login -u admin -p 1234 sparrow-harbor.fasoo.com:32023
docker push sparrow-harbor.fasoo.com:32023/infra/teamcity-agent:2021.2.2-linux-sudo-sparrow-1
