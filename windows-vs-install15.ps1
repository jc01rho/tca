Write-Host "---------------------------------------------------------------"
Write-Host "##teamcity[progressStart 'MSbuild 15 installing ... ']"
...
# Remove-Item "vs_buildtools15.exe"
...
Write-Host "##teamcity[progressFinish 'MSbuild 15 installing ... ']"